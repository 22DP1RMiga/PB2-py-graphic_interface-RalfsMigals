...
# Mūzikai un skaņām
def mainSound():
    winsound.PlaySound('furret walk around the world.mp3', winsound.SND_FILENAME)
...
# 15) Nejaušie burbuļi un rezultāts
BURB_NEJAUSI = 10
...
# 6, 10, 13, 16) Spēles galvenais cikls
while time() < beigas:
    mainSound()
